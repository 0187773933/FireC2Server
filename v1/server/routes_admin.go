...
func ( s *Server ) SetupAdminRoutes() {
	...
	s.FiberApp.Post( "/browser/ready" , validate_browser_mw , s.BrowserReady )
	s.FiberApp.Post( "/browser/readyfresh" , validate_browser_mw , s.BrowserReadyFresh )
