...
func ( s *Server ) SetupAdminRoutes() {
	...
	// spotify.Get( "/shuffle/:state" , SpotifySetShuffle )
	// spotify.Get( "/song/:song_id" , SpotifySong )
	// spotify.Get( "/playlist/:playlist_id" , SpotifyPlaylist )
	spotify.Get( "/playlist-shuffle/:playlist_id" , s.GetSpotifyPlaylistWithShuffle )
